<div class="container" style="margin-bottom: 100px">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo base_url();?>index.php/Painel_Aluno/atualizar_perfil" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label>Senha:</label>
                            <input type="text" class="form-control" value="<?php echo $senha;?>" name="senha" required />
                        </div>
                        <div class="form-group">
                            <label>Status (pequena frase que você gosta)</label>
                            <textarea name="status" class="form-control" rows="4" required maxlength="200" ><?php echo $status;?></textarea>
                        </div>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
      <form action="<?php echo base_url()?>index.php/Painel_Aluno/atualizar_imagem" method="post" enctype="multipart/form-data">
